...
const Header = () => {
  return (
    <div className="p-4 flex flex-col md:flex-row justify-between items-center">
      {/* Logo */}
      <img src="/Logo.svg" alt="Logo" className="h-12 w-24 mb-4 md:mb-0" />

      {/* Centering the links for larger screens, stacking for smaller screens */}
      <div className="font-bold text-purple-900 flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-8">
